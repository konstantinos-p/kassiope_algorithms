...
macro_df.to_csv('/Users/pkonstan/PycharmProjects/kassiope/assets/data/polling_2027-06-25_election/macro_df.csv', index=False)
...
df.to_csv('/Users/pkonstan/PycharmProjects/kassiope/assets/data/polling_2027-06-25_election/polling_data.csv', index=False)
infered_polling.to_csv('/Users/pkonstan/PycharmProjects/kassiope/assets/data/polling_2027-06-25_election/infered_polling.csv', index=False)
infered_polling_small_parties.to_csv('/Users/pkonstan/PycharmProjects/kassiope/assets/data/polling_2027-06-25_election/infered_polling_small_parties.csv', index=False)
...
bias_matrix.dropna(axis=0).to_csv('/Users/pkonstan/PycharmProjects/kassiope/assets/data/polling_2027-06-25_election/bias_matrix.csv',index_label='Pollster')
bias_matrix_commissioner.dropna(axis=0).to_csv('/Users/pkonstan/PycharmProjects/kassiope/assets/data/polling_2027-06-25_election/bias_matrix_commissioner.csv',index_label='Commissioner')
