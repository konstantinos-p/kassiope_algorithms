...
df_reg = compute_regression(debiased_df, start_date='2019-07-07', end_date='2023-07-07')
...
macro_df.to_csv('/Users/pkonstan/PycharmProjects/kassiope/assets/data/polling_2023_election/macro_df.csv', index=False)
...
df.to_csv('/Users/pkonstan/PycharmProjects/kassiope/assets/data/polling_2023_election/polling_data_2019_to_now_cleaned.csv', index=False)
infered_polling.to_csv('/Users/pkonstan/PycharmProjects/kassiope/assets/data/polling_2023_election/infered_polling.csv', index=False)
infered_polling_small_parties.to_csv('/Users/pkonstan/PycharmProjects/kassiope/assets/data/polling_2023_election/infered_polling_small_parties.csv', index=False)
...
bias_matrix.dropna(axis=0).to_csv('/Users/pkonstan/PycharmProjects/kassiope/assets/data/polling_2023_election/bias_matrix.csv',index_label='Pollster')
bias_matrix_commissioner.dropna(axis=0).to_csv('/Users/pkonstan/PycharmProjects/kassiope/assets/data/polling_2023_election/bias_matrix_commissioner.csv',index_label='Commissioner')
